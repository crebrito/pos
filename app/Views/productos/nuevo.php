    ...
    <div class="form-group">
        <div class="row">
            <div class="col-12 col-sm-6">
                ...
                <input type="text" name="codigo" id="codigo" class="form-control" value="<?= set_value('codigo') ?>"
                    placeholder="Código Producto" autofocus required>
            </div>
            <div class="col-12 col-sm-6">
        ...
        <div class="row">
            <div class="col-12 col-sm-6">
                ...
                <input type="text" name="precio_venta" id="precio_venta" class="form-control"
                    value="<?= set_value('precio_venta') ?>" placeholder="Precio Venta" required>
            </div>
            <div class="col-12 col-sm-6">
                <label for="precio_compra">Precio Compra</label>
                <input type="text" name="precio_compra" id="precio_compra" class="form-control"
                    value="<?= set_value('precio_compra') ?>" placeholder="Precio Compra" required>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12 col-sm-6">
                ...
                <input type="text" name="existencias" id="existencias" class="form-control"
                    value="<?= set_value('existencias') ?>" placeholder="Existencia" required>
            </div>
            <div class="col-12 col-sm-4">
                <label for="stock_minimo">Stock Mínimo</label>
                <input type="text" name="stock_minimo" id="stock_minimo" class="form-control"
                    value="<?= set_value('stock_minimo') ?>" placeholder="Stock Mínimo" required>
            </div>
